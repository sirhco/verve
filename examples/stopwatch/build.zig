//! Build wiring for the `stopwatch` example. Custom wasm client +
//! bridge live in this example; the framework's server + core types
//! come from `../../src/...`.
...
pub fn build(b: *std.Build) void {
    ...
    // Per-example wasm client. The framework's stock src/client/main.zig
    // exports counter-specific helpers; this example overrides it with
    // stopwatch-specific exports.
    ...
    const run_step = b.step("run", "Run the stopwatch server");
