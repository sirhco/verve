...
pub fn build(b: *std.Build) void {
    ...
    // gen_shadow_glb → shadow.glb → gl_asset_gen → shadow.vmesh
    // (cube on a floor; used by /shadow and /clip demos).
    ...
    // gen_skin_glb → skinbar.glb → gl_asset_gen → skinbar.vmesh
    // (3-joint rigged bar for the /skin skeletal-animation demo).
