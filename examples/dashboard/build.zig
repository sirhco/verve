//! Build wiring for the `dashboard` example. Shares the Verve framework
//! source tree with the root repository via `../../src/...`.
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Run the dashboard server");
