...
pub fn build(b: *std.Build) void {
    ...
    const mixed_vmesh_path = gl_asset_gen_mixed_run.addOutputFileArg("mixed.vmesh");
    ...
    const shadow_vmesh_path = gl_asset_gen_shadow_run.addOutputFileArg("shadow.vmesh");
    ...
    _ = wf_gl.addCopyFile(mixed_vmesh_path, "mixed.vmesh");
    _ = wf_gl.addCopyFile(shadow_vmesh_path, "shadow.vmesh");
