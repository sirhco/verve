...
Pre-1.0 (v0.1.x): public APIs break between minor versions. All three desktop backends (macOS, Windows, Linux GTK4) are verified on real hardware as of v0.2.0.
